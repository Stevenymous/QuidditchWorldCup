...
namespace QuidditchPresentationLayerWPF
{
    ...
    /// </summary>
    internal class StadeBusiness : EntiteBusiness, QuidditchBusinessLayer.IStade
    {
        #region Fields
        ...
        public StadeBusiness(int identifiant, string nom, string adresse, int nombreDePlace, float commission)
            : base(identifiant)
        {
            Nom = nom;
            Adresse = adresse;
