...
{
    /// <summary>
    /// Implémentation abstraite de IPersonne provenant de la BusinessLayer
    /// </summary>
    internal abstract class PersonneBusiness : EntiteBusiness, QuidditchBusinessLayer.IPersonne
    {
        #region Fields
        ...
        public PersonneBusiness(int identifiant, string prénom, string nom, DateTime dateDeNaissance)
            : base(identifiant)
        {
            Prenom = prénom;
            Nom = nom;
