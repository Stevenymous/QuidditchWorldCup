...
{
    /// <summary>
    /// Implémentation d'un Stade pour la couche QuidditchDataAccessLayerBaseDeDonnees 
    /// </summary>
    internal class StadeDal : EntiteDal, QuidditchDataAccessLayerBaseDeDonnees.IStade
    {
        #region Fields
        ...
        /// <summary>
        /// Propriété d'accès en lecture/écriture à la commission perçu par places
        /// </summary>
        ...
        public StadeDal(int identifiant, string nom, string adresse, int nombreDePlace, float commission)
            : base(identifiant)
        {
            Nom = nom;
            Adresse = adresse;
        ...
        public StadeDal(IStade stadeToCopy)
        ...
        /// </summary>
        /// <returns>La chaîne représentant l'objet Stade</returns>
        public override string ToString()
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("Nom du stade : ");
            builder.Append(Nom);
            builder.Append(" nombre de places : ");
            builder.Append(NombreDePlace);
