...
{
    /// <summary>
    /// Implémentation de l'équipe dans la couche QuidditchDataAccessLayerBaseDeDonnees
    /// </summary>
    internal class EquipeDal : EntiteDal, QuidditchDataAccessLayerBaseDeDonnees.IEquipe
    {
        #region Fields
        ...
        /// </summary>
        private IList<QuidditchDataAccessLayerBaseDeDonnees.IJoueur> _joueurs;
        ...
        /// </summary>
        public IList<QuidditchDataAccessLayerBaseDeDonnees.IJoueur> Joueurs
        {
            get 
            {
                return _joueurs; 
        ...
        public EquipeDal(int identifiant, string nom, string pays, IList<QuidditchDataAccessLayerBaseDeDonnees.IJoueur> joueurs)
            : base(identifiant)
        {
            Nom = nom;
            Pays = pays;
