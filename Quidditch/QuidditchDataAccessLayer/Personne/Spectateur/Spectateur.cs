...
namespace QuidditchDataAccessLayer
{
    ...
    internal class Spectateur : Personne, ISpectateur
    {
        ...
        /// <summary>
        /// List de réservation du spectateur
        /// </summary>
        ...
        public Spectateur(ISpectateur spectateurToCopy)
            : this(spectateurToCopy.Identifiant, spectateurToCopy.Prenom, spectateurToCopy.Nom, spectateurToCopy.DateDeNaissance, 
                spectateurToCopy.Adresse, spectateurToCopy.Email)
        {
